  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden">
      ...
      <header className="fixed top-4 left-4 right-4 z-50">
        <div className="max-w-4xl mx-auto glass rounded-2xl h-16 px-6 flex items-center justify-between">
          <motion.button 
            whileTap={{ scale: 0.9 }}
          ...
          >
            <img 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuAE47gKVWv-A-d_I7Z9M7wZVmhXhlXlMaPAZElR2ysA8xhzVhpqz75D8IdwDQ_KGjHaNUfT2yBHs1tcwSkiEt7Kr2gjRglEC6ieMaPLMGAqDI6R4X4zDhBwX-rTJaMLaIkKLo38Z6wANF-ffEmrP-a5-I8zV-muYoQSY6WexCtos8zjpZI-DPotcfouOm71o" 
      ...
      {/* Main Content */}
      <main className="pt-24 pb-32 px-4 max-w-4xl mx-auto relative z-10 min-h-screen">
      ...
      <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-md z-50">
        <div className="glass rounded-full h-20 flex justify-around items-center px-4">
          <NavItem 
...
function HomeScreen({ openDetail }: { key?: string; openDetail: (p: Product) => void }) {
  return (
    ...
    >
      {/* Rewards Widget */}
      <div className="glass rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex items-center gap-6">
          <div className="w-16 h-16 rounded-full overflow-hidden shadow-lg border border-gold/20 bg-white flex-shrink-0">
            <img 
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuCHXj2-mP5hXNVfGNRU-lI7Z9M7wZVmhXhlXlMaPAZElR2ysA8xhzVhpqz75D8IdwDQ_KGjHaNUfT2yBHs1tcwSkiEt7Kr2gjRglEC6ieMaPLMGAqDI6R4X4zDhBwX-rTJaMLaIkKLo38Z6wANF-ffEmrP-a5-I8zV-muYoQSY6WexCtos8zjpZI-DPotcfouOm71o" 
              alt="North End Logo" 
        ...
        <button className="w-full md:w-auto px-8 py-3 rounded-full border border-gold text-primary font-bold hover:bg-white/20 transition-all">
          Redeem Rewards
        </button>
      </div>
      ...
      {/* Hero Rituals */}
      <div 
        className="glass rounded-3xl p-8 min-h-[300px] flex flex-col justify-end relative overflow-hidden group cursor-pointer"
        onClick={() => openDetail(PRODUCTS[3])}
      >
        ...
        <div className="relative z-10 space-y-4">
          ...
          <button className="px-8 py-3 bg-primary text-white rounded-full font-bold shadow-lg hover:shadow-gold/20 transition-all">
            Order Now
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Seasonal Card */}
        <div className="glass rounded-3xl p-6 flex items-center justify-between gap-4 group cursor-pointer hover:bg-white/30 transition-all">
          <div className="space-y-1">
            <span className="text-[10px] font-bold uppercase tracking-widest text-secondary">Seasonal</span>
            <h3 className="font-headline text-xl font-bold">Maple Oat Latte</h3>
            <p className="text-sm text-primary/60 font-medium">Warm & comforting</p>
          </div>
          <div className="w-20 h-20 rounded-2xl overflow-hidden border-2 border-white shadow-md">
            <img src={PRODUCTS[3].image} className="w-full h-full object-cover" referrerPolicy="no-referrer" alt="Maple Oat Latte" />
          </div>
        </div>
        ...
        <div className="glass rounded-3xl p-6 space-y-4">
          ...
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-white/60 flex items-center justify-center border border-white">
              <Coffee size={24} />
            </div>
            <div>
  ...
  return (
    ...
    >
      <div className="text-center space-y-2">
        <h2 className="font-headline text-4xl font-bold tracking-tight text-glow">Our Menu</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredProducts.map((p, i) => (
          <motion.div
            ...
            className="glass rounded-3xl p-6 group hover:-translate-y-1 transition-all"
          >
            <div 
              className="aspect-square rounded-2xl overflow-hidden mb-6 bg-white/20 border border-white/40 relative cursor-pointer"
            ...
            <button 
              onClick={() => addToCart(p)}
              className="w-full py-4 rounded-2xl bg-primary text-white font-bold flex items-center justify-center gap-2 hover:bg-primary-container transition-all"
            >
...
function CartScreen({ 
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <button onClick={onBack} className="p-3 glass rounded-full hover:bg-white/40"><ArrowLeft size={24} /></button>
          ...
          <div key={item.id} className="glass rounded-3xl p-4 flex gap-4">
            ...
            <div className="flex-grow space-y-1">
              ...
              <div className="flex justify-between items-end pt-2">
                <div className="flex items-center gap-4 bg-white/40 rounded-full px-2 py-1 border border-white">
      ...
      {cartItems.length > 0 && (
        <div className="glass-dark rounded-3xl p-8 space-y-6 mt-12 mb-20 backdrop-blur-3xl border-white/10">
          ...
          <button className="w-full py-4 bg-primary text-white rounded-2xl font-bold tracking-widest uppercase shadow-xl hover:shadow-gold/10 transition-all flex items-center justify-center gap-2">
...
function ProfileScreen({ key }: { key?: string }) {
  return (
    ...
    >
      {/* Identity Card */}
      <div className="glass rounded-[2rem] p-8 space-y-6 relative overflow-hidden">
        ...
        <div className="flex items-center gap-6 relative z-10">
          ...
          <div className="space-y-2">
            ...
            <div className="inline-flex items-center gap-2 bg-secondary-container/80 px-3 py-1 rounded-full border border-gold/20 shadow-sm">
      ...
      <div className="space-y-8">
        ...
        <button className="w-full py-5 glass border-red-500/20 bg-red-50/20 text-red-600 rounded-3xl font-bold flex items-center justify-center gap-2 hover:bg-red-500 hover:text-white transition-all shadow-lg mt-8">
...
function ProfileLink({ icon, label }: { icon: ReactNode; label: string }) {
  return (
    <div className="glass rounded-2xl p-5 flex items-center justify-between group hover:bg-white/40 transition-all cursor-pointer">
      <div className="flex items-center gap-4">
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-2">
        <button onClick={onBack} className="p-3 glass rounded-full"><ArrowLeft size={24} /></button>
        ...
        <button className="p-3 glass rounded-full"><Heart size={24} /></button>
      </div>

      <div className="glass p-2 rounded-[2.5rem] relative aspect-[4/5] overflow-hidden group">
        <img src={product.image} className="w-full h-full object-cover rounded-[2rem] group-hover:scale-105 transition-transform duration-700" referrerPolicy="no-referrer" alt={product.name} />
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 w-[90%] max-w-md z-50">
        <motion.button 
          ...
          className="w-full py-5 bg-primary text-white rounded-full font-headline text-lg font-bold shadow-2xl flex items-center justify-center gap-3 relative overflow-hidden group border border-white/10"
        >
...
function CustomOption({ active, icon, label, detail }: { active?: boolean; icon: ReactNode; label: string; detail: string }) {
  return (
    <div className={`p-4 rounded-2xl flex flex-col items-center justify-center gap-1 border-2 transition-all cursor-pointer ${
      active 
...
function CustomPill({ active, label }: { active?: boolean; label: string }) {
  return (
    <div className={`py-3 rounded-xl flex items-center justify-center text-center font-bold text-sm border transition-all cursor-pointer ${
      active 
